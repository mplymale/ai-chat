...
export default async function handler(req, res) {
  ...
  try {
    ...
    try {
      const urls = [
        "https://www.mikeplymale.com",
        "https://www.mikeplymale.com/approach",
        "https://www.mikeplymale.com/casestudies",
        "https://www.mikeplymale.com/synchrony",
      ];
...
- Available keys:
  synchrony, veritiv, mohawk, marine-max, sazerac, bunzl, usmc, houston-methodist,
